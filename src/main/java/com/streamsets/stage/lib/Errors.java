...
public enum Errors implements ErrorCode {
    ...
    ERROR_451("TCP Connection has established, However the TDP cannot get send Message.{}"),
    ERROR_454("TCP Connection Has failed. Check Melsec TDP port is opened or ping command reachable{}"),
